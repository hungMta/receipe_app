...
class _$_Recipe implements _Recipe {
  ...
  @override
  String toString() {
    return 'Recipe(calories: $calories, carbos: $carbos, description: $description, difficulty: $difficulty, fats: $fats, headline: $headline, image: $image, name: $name, proteins: $proteins, thumb: $thumb, time: $time)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, calories, carbos, description,
      difficulty, fats, headline, image, name, proteins, thumb, time);
